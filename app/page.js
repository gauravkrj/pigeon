    ...
    <section className="bg-gray-50 dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
        <div className="flex flex-col justify-center">
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Empowering Education, Connecting Minds</h1>
                      <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">
                      At Pigeon, we believe that parents and teachers are partners in their child's education. We help them work together to create a supportive environment where every student can succeed.                      </p>
          <a href="#" className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">SignIn to Your Success
          ...
          <div className="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
            ...
            <form className="mt-8 space-y-6" action="#">
              ...
              <div className="text-sm font-medium text-gray-900 dark:text-white">
                Not registered yet? <a className="text-blue-600 hover:underline dark:text-blue-500">Request to create an account</a>
              </div>
            </form>
          </div>
        </div>
