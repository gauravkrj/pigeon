        ...
        <div className="w-full">
          <div className="flex flex-col items-center max-w-lg mx-auto text-center">
            ...
            <div className="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
              <a href="#" className="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg dark:text-gray-200 gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:border-gray-700">
