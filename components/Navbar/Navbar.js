...
import Logo from "../../public/pigeon.gif"
const Navbar = () => {
  return (
    ...
    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <Image src={Logo} className=" -scale-x-100 -mr-4 " alt="Pigeon Logo" width={100} height={50} />
      <span className='text-white mt-6 ml-2 text-2xl'>Pigeon</span>
      ...
      <div className="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <Link href="/developers" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Developers</Link>
        </ul>
      </div>
    </div>
  </nav>
